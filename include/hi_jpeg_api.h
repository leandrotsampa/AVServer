   ...
   extern "C" 
{
    ...
    */
    ...
    \param[in]  *pu64DecHandle.  CNcomment:返回解码器句柄 CNend
    ...
    ::HI_JPEG_CreateDec
    */
    HI_S32 HI_JPEG_CreateDec(HI_U64 *pu64DecHandle);
    ...
    \param[in]  u64DecHandle.  CNcomment:解码器句柄 CNend
    ...
    ::HI_JPEG_DecInfo
    */
    HI_S32 HI_JPEG_DecInfo(HI_U64 u64DecHandle,HI_JPEG_INMSG_S *stInMsg);
    ...
    ::HI_JPEG_DecOutInfo
    */
    HI_S32 HI_JPEG_DecOutInfo(HI_U64 u64DecHandle,HI_JPEG_OUTMSG_S *stOutMsg);
    ...
    ::HI_JPEG_Decode
    */
    HI_S32 HI_JPEG_Decode(HI_U64 u64DecHandle,HI_JPEG_INMSG_S *stInMsg,HI_JPEG_OUTMSG_S *stOutMsg);
	...
	\param[in]	u64DecHandle.    CNcomment:解码句柄 CNend
	\param[out]	u64LuPixSum. CNcomment:输出亮度值 CNend
	...
	*/
	HI_S32 HI_JPEG_GetOmxLuPixSum(HI_U64 u64DecHandle,HI_U64 *u64LuPixSum);
    ...
    ::HI_JPEG_DestoryDec
    */
    HI_S32 HI_JPEG_DestoryDec(HI_U64 u64DecHandle);

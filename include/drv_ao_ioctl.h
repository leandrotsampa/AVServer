...
/*AO Cast command code*/
 ...
 #define CMD_AO_SND_DMACREATE _IOWR (HI_ID_AO, 0x78, AO_SND_DMACreate_Param_S)
 #define CMD_AO_SND_DMADESTORY _IOWR (HI_ID_AO, 0x79, AO_SND_DMADestory_Param_S)
 #define CMD_AO_SND_DMASETSAMPLERATE _IOWR (HI_ID_AO, 0x7a, AO_SND_DMASetSampleRate_Param_S)
